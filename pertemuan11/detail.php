    ...
    <div class="row">
        ...
        <div class="col-md-10 p-5 pt-4">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">Alamat : <?= $camaba[
                    'alamat'
                ] ?></li>
                <li class="list-group-item">Jenis Kelamin : <?= $camaba[
                    'jenis_kelamin'
                ] ?></li>
                <li class="list-group-item">Agama : <?= $camaba['agama'] ?></li>
                <li class="list-group-item">Sekolah Asal : <?= $camaba[
                    'sekolah_asal'
                ] ?></li>
                <li class="list-group-item"><img src="image/<?= $camaba[
                    'foto_maba'
                ] ?>" alt=""></li>
                <li class="list-group-item">
                <a href="edit.php?id=<?= $camaba[
                    'id'
                ] ?>" class="btn btn-warning" role="button">Edit</a> |
                <a href="hapus.php?id=<?= $camaba[
                    'id'
                ] ?>" onclick="return confirm('Apakah Anda ingin menghapus data ini');" class="btn btn-danger" role="button">Hapus</a> |

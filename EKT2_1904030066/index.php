...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-10 p-5 pt-4">
            <h3><i class="fas fa-users"></i> Daftar Calon Mahasiswa
                <hr>

                <!-- Pencarian Data -->
                <form action="" method="POST">
                    <input type="text" id="keyword" size="35" name="keyword" placeholder="Masukan Keyword" autocomplete="off">
            ...
            <table class="table table-striped">
                ...
                <?php if (empty($camaba)): ?>
                    <tr>
                        <td colspan="4" class="alert alert-danger text-center" role="alert">
                            <p>
                                <b>Data Mahasiswa tidak ditemukan</b>
                            </p>
                        </td>
                    </tr>
                    <?php endif; ?>
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td><img src="image/<?php echo $cmb[
                            'foto_maba'
                        ]; ?>" width="100px"></td>
                        <td><a href="detail.php?id=<?= $cmb[
                            'id'
